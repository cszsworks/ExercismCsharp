static class GameMaster
{
    ...
    public static string Describe(Character character, Destination destination) => $"{GameMaster.Describe(character)} {GameMaster.Describe()} {GameMaster.Describe(destination)}";
}
